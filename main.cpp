...
int main() {
    ...
    */
    ...
    // cout << "Should be positive definite (expect 1): " <<
    // sys_pd.isPositiveDefinite() << endl;
    ...
    // cout << "Should NOT be positive definite (expect 0): " <<
    // sys_not_pd.isPositiveDefinite() << endl; Matrix tri_pd(3, 3); tri_pd(1,
    // 1) = -2; tri_pd(1, 2) = -1; tri_pd(1, 3) = 0; tri_pd(2, 1) = -1;
    // tri_pd(2, 2) = 2;
    // tri_pd(2, 3) = -1;
    // tri_pd(3, 1) = 0;
    // tri_pd(3, 2) = -1;
    ...
    // cout << "Should be positive definite (expect 1): " <<
    // sys_tri_pd.isPositiveDefinite() << endl;
